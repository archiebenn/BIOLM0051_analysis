...
#### 2.1 `run_all.sh`
Run the following from the project root to execute all script in the correct order for this pipeline (ensure this is executable first with `chmod +x scripts/run_all.sh`):  
```bash
scripts/run_all.sh
```
