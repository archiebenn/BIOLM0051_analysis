...
### b) script for preliminary checking of fastq format for each file provided. note - won't be helpful for very large datasets, but for this analysis it's fine as only a few files
```bash
