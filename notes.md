...
for x in {A..D}; do      
    ...
    # creates array called files of all files beginning with sample{letter of loop}                                             
    files=(sample${x}*)                                               
    ...
    # sed substitution to remove header spaces - check headers (start with @) capture up to space and replace with capture followed by underscore, globally:
