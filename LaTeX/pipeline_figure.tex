...
\begin{tikzpicture}[node distance=2.4cm]
				\node (start) [startstop] {\textbf{\texttt{samples.zip}}};
				\node (pro2) [process, below of=start, align=center] {\textbf{QC and pre-processing}\\Extraction, concatenation, \\masking, and FASTQ to FASTA};
				\node (pro3) [process, below of=pro2, align=center] {\textbf{BLAST search}\\Remote \texttt{blastn} against query FASTAs};
				\node (pro4) [process, below of=pro3, align=center] {\textbf{BLAST filtering}\\ BLAST hit sorting \\and take top hits by species};\textsc{}
				...
				\node (pro7a) [process, below of=pro6, align=center] {\textbf{Combined FASTA}\\Query FASTA merged with \\BLAST hit FASTAs};
				...
				\node (pro9) [process, below of=pro8, align=center] {\textbf{Tree building and Viewing}\\Build with \texttt{iqtree3} and \\produce trees using Biopython};
